...
| **v31** (3.28.0) | **车辆位置显示所在地区天气**：天气现象/温度/湿度/风向风力（高德天气）；位置页新增可选的「高德天气 Key」配置 |
| **v30** (3.27.0) | **完善开源致谢**：App 内「关于我们」页新增 **hasscc/wuling**（车控协议思路来源）署名，第三方组件清单补全 |

> 📜 **更早版本**（v30 及以前）请见 [**Releases 页面**](https://github.com/daiyuxiang520/geren-update/releases)。
