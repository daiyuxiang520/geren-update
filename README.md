...
| 版本 | 说明 |
|---|---|
| **v40** (3.37.0) | **重做位置页地图交互**：小地图改为**静态预览**（不再和页面抢手势，页面一路滑到底）；右上角新增**「全屏」按钮**，打开独立全屏地图可自由平移缩放。起因是 v38 加整页滚动后地图嵌在滚动容器里，手势被 Compose 截走 → 地图不动、页面在滚 |
...
> 📜 **更早版本**（v34 及以前）请见 [**Releases 页面**](https://github.com/daiyuxiang520/geren-update/releases)。
