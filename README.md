...
| **v29** (3.26.0) | **更新下载支持手动选择加速源**：弹窗内实时查看各加速源延迟并手动指定（仅本次生效），默认仍自动择优 |

> 📜 **更早版本**（v28 及以前）请见 [**Releases 页面**](https://github.com/daiyuxiang520/geren-update/releases)。
